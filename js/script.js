...
// MODIFICACION DE FUNCIONES DE LAS PREVISIONES DENTAL

let odontologia= document.getElementById("odontologia");


let cambio = dental.map(function (all) {

    if (all.prevision === "FONASA")
        all.prevision = "ISAPRE";

    else if (all.prevision === "ISAPRE")
             all.prevision = "FONASA";
           
           
              odontologia.innerHTML  += (`${all.prevision} ; ${all.paciente} - ${all.rut}.<br> <br>`);
    return all;
  });